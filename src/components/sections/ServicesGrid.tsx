...
const serviceIcons = [
  ...
  <svg key="5" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342" /></svg>,
  <svg key="6" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>,
];
    ...
    <section className="bg-navy-950 py-32 sm:py-40">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="mt-4 max-w-2xl text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl">
            {t("subtitle")}
          </h2>
        </motion.div>

        <div className="mt-20 grid gap-px bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
          {serviceKeys.map((key, i) => (
            <motion.div
              ...
              className="group bg-navy-950 p-10 transition-colors hover:bg-navy-900"
            >
              <div className="text-accent transition-colors group-hover:text-accent-light">
                {serviceIcons[i]}
              </div>
